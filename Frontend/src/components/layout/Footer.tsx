...
const Footer: React.FC = () => {
  return <footer className="bg-blue-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">MedReminder</h3>
            <p className="text-blue-100 mb-4">
              Your trusted medication reminder system to help patients and
              caregivers manage prescriptions effectively.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPinIcon size={20} className="mr-2 flex-shrink-0 mt-0.5" />
        ...
        <div className="mt-8 pt-6 border-t border-blue-700 text-center text-blue-200">
          <p>
            &copy; {new Date().getFullYear()} MedReminder. All rights reserved.
          </p>
        </div>
      </div>
    </footer>;
